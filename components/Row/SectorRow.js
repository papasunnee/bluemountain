...
import { Sectors } from "../Sector/SectorForm";

export default class SectorRow extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
          ...
          <Row>
            ...
            {Sectors.map((sector, key) => (
              <Col className="mb-5" xs="12" md="4" key={key}>
                <LeadershipSolution sector={sector} />
              </Col>
            ))}
          </Row>
        </Container>
  ...
  return (
    <Fragment>
      <div className="leaderWrapper">
        <img
          src={`/static/images/sectors/${sector.imageSrc}.png`}
          className="img-fluid"
        />
        <Link href={`/sector/${sector.href}`}>
          <a>
