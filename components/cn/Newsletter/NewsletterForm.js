    ...
    return (
      <Fragment>
        <Container style={{ marginTop: "50px", marginBottom: "50px" }}>
          <Row>
            <Col md={7}>
              <Mutation mutation={NEWSLETTER_SUBSCRIPTION_MUTATION}
                onCompleted={({subscribeToNewsletter: {address}}) => this.setState({
                  ...initState,
                ...
                {(subscribeToNewsletter, { loading }) => (
                  <Form onSubmit={e => {
                    ...
                    { loading ? <Loading /> : <Button type="submit">SUBSCRIBE</Button> }
                  </Form>
                )}
              </Mutation>
            </Col>
